...
const Navbar = () => {
    ...
    return (
        <div>
            <div className=" w-[1100px] h-[44px] justify-center  ">
                <Image
                    src="/Images/logo.png"
                    alt="logo"
                    width={130.6}
            ...
            <div className=" hidden md:flex w-[1350px] h-[70px] top-[170px] left-[100px] border-b-[1px] pr[64px] pl-[64px] bg-[#F7F7F7] border-[#676767] -mt-6">
                <ul className="w-[400px] h-[44px] gap-[34px] ml-[570px] justify-center">
